...
void co60_1(){
    ...
    double null_ang[10] =  {55,60,90,105, 120, 135, 150, 165,180,185};
    double exp_s_err[8];
	...
	TH1F *frame00 = Rvstheta->DrawFrame(55,800,185,1050);
	...
	TGraphErrors * graph1 = new TGraphErrors(8,exp_ang, exp_count2,0,exp_s_err);
    ...
    TLegend *legCo = new TLegend(0.2, 0.6, 0.5, 0.8);/*legCo->SetFillColor(0);*/ legCo->SetTextSize(0.03);legCo->SetBorderSize(0);legCo->SetFillStyle(0);legCo->SetTextSize(0.04);
